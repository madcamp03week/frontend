...
export default function PrivateKeyDisplayModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center z-[9999] p-4">
      <div className="backdrop-blur-xl bg-gray-800/80 rounded-2xl p-6 max-w-2xl w-full mx-4 border border-gray-700/50 shadow-2xl">
        {/* 헤더 */}
        ...
        {/* 지갑 주소 */}
        <div className="mb-6 p-4 bg-gray-700 rounded-lg border border-gray-600/50">
              ...
              <div className="space-y-4">
                ...
                {copied && (
                  <div className="p-3 bg-green-500/10 border border-green-500/20 rounded-lg">
                    <p className="text-green-400 text-sm">클립보드에 복사되었습니다!</p>
                  </div>
                )}
              </div>
            )}
        ...
        <div className="mt-6 p-4 bg-red-500/10 border border-red-500/20 rounded-lg">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-gray-300 text-sm leading-relaxed">
                <strong>보안 경고:</strong> Private Key는 절대 타인과 공유하지 마세요. 
                이 키로 지갑의 모든 자산에 접근할 수 있습니다.
              </p>
            </div>
          </div>
        </div>
